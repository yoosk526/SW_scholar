...
while video_capture.isOpened():
    ...
    if parked_car_boxes is None or len(parked_car_boxes) == 0:
        ...
        data = {
            ...
            "timestamp": 1662094009000,
            "payload": {
                "A1": {"isfree": np.array2string(free_space[0]), "inTime": 1662094009000, "outTime": 0},
                "A2": {"isfree": np.array2string(free_space[1]), "inTime": 1662094009000, "outTime": 0},
                "A3": {"isfree": np.array2string(free_space[2]), "inTime": 1662094009000, "outTime": 0},
                "A4": {"isfree": np.array2string(free_space[3]), "inTime": 1662094009000, "outTime": 0},
                "A5": {"isfree": np.array2string(free_space[4]), "inTime": 1662094009000, "outTime": 0},
                "A6": {"isfree": np.array2string(free_space[5]), "inTime": 1662094009000, "outTime": 0},
